...
print("Result item_1 + item_2",result_sum)
...
print("Result item_2 - item_1",result_subtr)
...
print("Result item_1 * item_2",result_multi)
...
print("Result item_1 ** item_2",result_exp)
...
print("Result_m_exp = pow(item_1,item_2)",result_m_exp)

#  13. Создать переменную result_s_root в которой вы найдёте квадратный корень любой из переменной item1
result_s_root = math.sqrt(15)

#  14. Вывести result_s_root в консоль.
print("Result_s_root  = ",result_s_root)

#  15. Создать переменную result_m_s_root в которой вы найдёте квадратный корень любой из переменной item2 используя библиотеку math.
result_m_s_root = math.sqrt(item_2)

#  16. Вывести result_m_s_root в консоль.
print("Result_m_s_root = math.sqrt(item_2)",result_m_s_root)
...
result_mp_s_root = math.pow(item_1,item_2)

#  18. Вывести result_mp_s_root в консоль.
print("Result_mp_s_root = math.pow(item_1,item_2)",result_mp_s_root)
...
print("Result_division int",result_int)
...
print("b_item_1_int =",type(b_item_1_int))
